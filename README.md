...
You can copy the content of one of the snippet file into the 'tools/STRAssembly/src/main.cpp' file and relaunch the build.

For instance:

    cp [path-to-gatb-core]/examples/debruijn/debruijn4.cpp tools/STRAssembly/src/main.cpp
